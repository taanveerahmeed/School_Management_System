...
public abstract class RegistrationForm extends JPanel {
	...
	RegistrationForm (){
		...
		fontForAll = new Font ("Serif",Font.ITALIC+Font.BOLD,16);
		...
		p1.add(pd = new JLabel ("Personal Details"));
                p1.add(ins = new JButton ("Instructions"));
		...
		p10.add(new JLabel ("Academic Information"));
		add(p10);
